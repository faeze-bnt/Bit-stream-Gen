...
Stream_In_1 =  Fugen_approx(In(1),Stream_Length,Parallel_deg);
Stream_In_2 =  Fugen_approx(In(2),Stream_Length,Parallel_deg);
Stream_In_3 =  Fugen_approx(In(3),Stream_Length,Parallel_deg);
Stream_In_4 =  Fugen_approx(In(4),Stream_Length,Parallel_deg);
Stream_In_5 =  Fugen_approx(In(5),Stream_Length,Parallel_deg);
Stream_In_6 =  Fugen_approx(In(6),Stream_Length,Parallel_deg);
Stream_In_7 =  Fugen_approx(In(7),Stream_Length,Parallel_deg);
Stream_In_8 =  Fugen_approx(In(8),Stream_Length,Parallel_deg);
Stream_In_9 =  Fugen_approx(In(9),Stream_Length,Parallel_deg);
